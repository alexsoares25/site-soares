...
onScroll(); // executar uma vez no load
```
...
// Seleciona os principais blocos de conteúdo para animar
...
// Agrupa elementos por seção para delay escalonado
...
// Aplica classes de animação com delays
...
// Injeta keyframes para o ripple
